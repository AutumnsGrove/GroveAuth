...
test.describe('Passkey Login', () => {
  ...
  test('should successfully login with registered passkey', async ({ page }) => {
  ...
  test('should handle no matching passkey gracefully', async ({ page, webauthn }) => {
  ...
  test('should redirect to correct page after passkey login', async ({ page }) => {
  ...
  test('should fail login when user verification fails', async ({ page, webauthn }) => {
