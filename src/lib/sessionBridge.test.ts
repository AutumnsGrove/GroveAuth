...
describe('Session Bridge: Request Registration', () => {
  describe('registerRequestForBridge', () => {
    it('should register a request with environment context', () => {
      const request = new Request('https://auth-api.grove.place/api/auth/sign-in');
    ...
    it('should track each request independently', () => {
      const request1 = new Request('https://auth-api.grove.place/api/auth/sign-in/google');
      const request2 = new Request('https://auth-api.grove.place/api/auth/sign-in/discord');
  ...
  describe('getRequestContext', () => {
    it('should return undefined for unregistered requests', () => {
      const request = new Request('https://auth-api.grove.place/api/auth/unregistered');
...
describe('Session Bridge: Result Tracking', () => {
  describe('setSessionBridgeResult / getSessionBridgeResult', () => {
    it('should store and retrieve session bridge result', () => {
      const request = new Request('https://auth-api.grove.place/api/auth/callback');
    ...
    it('should return undefined for requests without results', () => {
      const request = new Request('https://auth-api.grove.place/api/auth/no-result');
    ...
    it('should isolate results per request', () => {
      const request1 = new Request('https://auth-api.grove.place/api/auth/req1');
      const request2 = new Request('https://auth-api.grove.place/api/auth/req2');

      const result1: SessionBridgeResult = { sessionId: 'sess_1', userId: 'user_1' };
      const result2: SessionBridgeResult = { sessionId: 'sess_2', userId: 'user_2' };
...
describe('Session Bridge: Cleanup', () => {
  describe('cleanupRequestContext', () => {
    ...
    it('should remove bridge result after cleanup', () => {
      const request = new Request('https://auth-api.grove.place/api/auth/sign-in');
      const result: SessionBridgeResult = { sessionId: 'sess_123', userId: 'user_456' };
    ...
    it('should handle cleanup of non-existent request gracefully', () => {
      const request = new Request('https://auth-api.grove.place/api/auth/never-registered');
...
describe('Session Bridge: WeakMap Behavior', () => {
  ...
  it('should allow garbage collection of cleaned up requests', () => {
    ...
    let request: Request | null = new Request('https://auth-api.grove.place/api/auth/temp');
    const result: SessionBridgeResult = { sessionId: 'sess_temp', userId: 'user_temp' };
...
describe('Session Bridge: Complete Flow Simulation', () => {
  it('should handle successful OAuth flow', async () => {
    ...
    const request = new Request('https://auth-api.grove.place/api/auth/callback/google');
    registerRequestForBridge(request, mockEnv);
  ...
  it('should handle failed SessionDO creation gracefully', async () => {
    const request = new Request('https://auth-api.grove.place/api/auth/callback/discord');
    registerRequestForBridge(request, mockEnv);

    // Simulate: SessionDO creation fails
    const errorResult: SessionBridgeResult = {
      sessionId: '',
      userId: 'user_discord_123',
  ...
  it('should handle request not registered (hook called without registration)', () => {
    ...
    const request = new Request('https://auth-api.grove.place/api/auth/magic-link');
